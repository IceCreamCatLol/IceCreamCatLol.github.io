...
document.documentElement.style.setProperty('--primary-color', '#EAB308');
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
	...
	"My irl name is Max! :D",
	"If you're homophobic then block me you fuckin retard! :D",
	"Never lose your \":D\"!"
  ];
  let bioText = '';
  let bioIndex = 0;
